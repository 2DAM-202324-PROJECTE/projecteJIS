<form class="m-10" wire:submit.prevent="createCategory" xmlns:wire="http://www.w3.org/1999/xhtml" enctype="multipart/form-data">
                        ...
                        <div class="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
                            <div class="text-center">
                                ...
                                <div wire:loading.remove wire:target="image">
                                    @if ($image)
                                        <img src="{{ $image->temporaryUrl() }}" alt="Category Image" class="mx-auto h-48 w-auto">
                                    @else
