...
{{--                        />--}}
                        ...
                        <div>
                            ...
                            <h3 class="text-sm text-gray-900">
                                ...
                                <button class="text-sm p-1 border-2 rounded border-gray-200 hover:border-gray-300 bg-gray-200 hover:bg-gray-300" wire:click="updateCartItem({{ $id }}, 'minus')"> - </button>


                                {{ $item->get('name') }}

                                <button class="text-sm p-1 border-2 rounded border-gray-200 hover:border-gray-300 bg-gray-200 hover:bg-gray-300" wire:click="updateCartItem({{ $id }}, 'plus')"> + </button>
...
{{--                            </dl>--}}
                        ...
                        <div class="flex flex-1 items-center justify-end gap-2">
                            ...
                            <button class="text-gray-600 transition hover:text-red-600" wire:click="removeFromCart({{ $id }})">
...
{{--        <div class="w-1/4" xmlns:wire="http://www.w3.org/1999/xhtml">--}}
...
{{--                @else--}}
{{--                    <p class="text-3xl text-center mb-2">Buit, TO DO!</p>--}}
{{--                @endif--}}
{{--            </div>--}}
{{--        </div>--}}
    </div>
