        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('admin') }}">
                        <div class="mb-4 mr-4 block h-9 w-auto">
                            <img class=" h-14" src="{{ asset('Img/logoSimple.png') }}" alt="Pc Planet">
                        ...
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                ...
                                @if (Auth::user()->role === 'admin')
                                    <x-dropdown-link href="{{ route('welcome') }}">{{ __('translate.INICI_TXT') }}</x-dropdown-link>
                                @endif
