...
<div class="px-4 sm:px-6 lg:px-8">
    <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto">
            ...
            <p class="mt-2 text-sm text-gray-700">A list of all the products including their name, description, price, and stock.</p>
        </div>
                    ...
                    @foreach ($productes as $product)
                        <tr>
                            ...
                            <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-0">
                                <a href="#" class="text-indigo-600 hover:text-indigo-900">Edit<span class="sr-only">, {{ $product->name }}</span></a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
